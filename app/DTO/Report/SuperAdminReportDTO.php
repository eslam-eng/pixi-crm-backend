...
class SuperAdminReportDTO
{
    public function __construct(
        public ?string $date_from = null,
        public ?string $date_to = null,
        public ?array $client_ids = null,
        public ?array $subscription_statuses = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            subscription_statuses: $data['subscription_statuses'] ?? null,
    ...
    public static function fromRequest(Request $request): self
    {
        return new self(
            ...
            subscription_statuses: $request->input('subscription_statuses'),
