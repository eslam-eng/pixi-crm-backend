...
class TeamPerformanceReportDTO extends BaseDTO
{
    ...
    {
        return false; // Team performance doesn't use stages
    }
    ...
    {
        return false; // Team performance doesn't use statuses
    }
    ...
    {
        return false; // Team performance doesn't use sources
    }
    ...
    {
        return false; // Team performance doesn't use search
    }
