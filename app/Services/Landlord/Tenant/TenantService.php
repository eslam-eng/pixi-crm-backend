...
use App\Models\Tenant\Filters\TenantsFilter;
...
{
    public function __construct(protected readonly Tenant $model, protected readonly SubscriptionService $planSubscriptionService) {}
